...
function Edit() {
  const [addingTodo, setAddingTodo] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useState)(false);
  const [newTodo, setNewTodo] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useState)('');
  ...
  const actions = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useDispatch)('wp-todos/todos');
  const addTodo = actions && actions.addTodo;
  const toggleTodo = actions && actions.toggleTodo;
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)()
  }, todos && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ol", null, todos?.map((todo, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: todo.id,
    ...
    type: "submit",
    isPrimary: true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Add Todo', 'wp-todos')))));
}
...
/* harmony import */ var _todos_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todos-store */ "./src/todos-store/index.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('blocks-course/wp-todos', {
...
function save() {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Hi There"));
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  FETCH_TODOS() {
    return window.fetch('https://jsonplaceholder.typicode.com/todos?_limit=30').then(res => {
      if (res.ok) {
        return res.json();
      }
  ...
  CREATE_TODO({
    ...
    const data = {
      title,
      completed: false,
      userId: `u-${new Date().getDate()}-${Math.floor(Math.random().toFixed(10) * 99999999)}`
    };
    return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('https://jsonplaceholder.typicode.com/todos', {
      data
    });
  },
  TOGGLE_TODO({
    ...
    return axios__WEBPACK_IMPORTED_MODULE_1__["default"].patch(`https://jsonplaceholder.typicode.com/todos/${todo.id}`, {
...
const store = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.createReduxStore)('wp-todos/todos', {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkwp_todos"] = globalThis["webpackChunkwp_todos"] || [];
